...
Azure는 광범위한 클라우드 기반 서비스를 제공하며, 매월 기능이 추가되고 향상됩니다. 

[![Azure 서비스의 큰 그림 보기를 보여 주는 다이어그램](../media/2-azure-services.png "Azure 서비스")](../media/2-azure-services.png#lightbox)

일반적으로 사용되는 몇 가지 기능을 자세히 살펴보겠습니다. 

- [Compute](#compute-services)
- [네트워킹](#networking-services)
- [Storage](#storage-services)
- [모바일](#mobil-services)
- [데이터베이스](#database-services)
- [웹](#web-services)
...
Compute Services는 기업이 Azure 플랫폼으로 이전하는 주된 이유 중 하나입니다. Azure는 응용 프로그램 및 서비스를 호스트하는 다음과 같은 다양한 옵션을 제공합니다.

![IaaS, PaaS 및 FaaS 비교](../media/2-iaas-paas-faas.png)

다음은 Azure의 IaaS, PaaS 및 FaaS에 대한 몇 가지 예입니다.

|  유형  |  서비스 이름             | 서비스 함수                                                         |
|--------|---------------------------|--------------------------------------------------------------------------|
| IaaS   | Azure Virtual Machines    | Azure에서 호스트되는 Windows 또는 Linux VM입니다.                                     | 
...
Azure를 사용하면 개발자가 원하는 개발 환경을 사용하여 다양한 언어로 iOS, Android 및 Windows 앱을 쉽고 빠르게 구축할 수 있습니다. 회사 로그인을 추가한 후에 SAP, Oracle, SQL Server, SharePoint 등의 온-프레미스 리소스에 연결하는 작업과 같이 시간이 오래 걸리고 프로젝트 위험을 높이는 기능을 이제 간단히 포함시킬 수 있습니다.

이 서비스에는 다음과 같은 다른 기능이 있습니다.
