<span data-ttu-id="8e87e-101">이 단원에서는 ASP.NET Core 웹앱을 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="8e87e-101">In this unit, you will create an ASP.NET Core web app.</span></span>
