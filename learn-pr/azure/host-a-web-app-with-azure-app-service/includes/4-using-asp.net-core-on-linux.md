웹 응용 프로그램을 빌드하기 위해 오픈 소스 기술을 사용하기로 했습니다. ASP.NET Core는 플랫폼 간 및 오픈 소스 프레임워크임을 알고 있습니다. ASP.NET Core를 사용 하 여 Linux 개발 환경에서 웹 앱을 개발 하려는!

Azure App Service를 사용 하면 즐겨 찾는 웹 기술, Node.js, PHP 또는.NET Core를 포함 하 여 사용할 수 있습니다.
...
웹 응용 프로그램을 빌드하려는 경우 많은 언어와 프레임워크를 선택할 수 있습니다. App Service는 다양 한 유형의 응용 프로그램, Node.js, PHP 또는.NET Core와 같은 호스트 하 여이 선택 쉽게 하는 데 도움이 됩니다. 이 옵션을 사용 하면 언어 및 프레임 워크에 익숙한 대부분의 웹 호스트의 요구 사항에 맞게 변경 하는 대신 사용할 수 있습니다.
