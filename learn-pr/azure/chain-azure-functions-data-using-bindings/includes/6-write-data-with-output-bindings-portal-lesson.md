<span data-ttu-id="a9570-101">입력 바인딩과 마찬가지로 출력 바인딩에도 여러 형식이 있습니다.</span><span class="sxs-lookup"><span data-stu-id="a9570-101">Similar to input bindings, there are multiple types of output bindings.</span></span>
