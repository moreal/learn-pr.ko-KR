...
Azure CLI는 다른 스크립팅 언어(예: Ruby 및 Python)와 함께 사용할 수 있습니다. 두 언어는 모두 개발자가 PowerShell에 익숙하지 않을 수 있는 비 Windows 기반 컴퓨터에서 일반적으로 사용됩니다.
...
- 리소스 사용량 정보 검색
- Virtual Machines 만들기 및 관리
- Virtual Machine Scale Sets 만들기 및 관리
...
알 수 있듯이, Azure는 리소스를 만들고 관리할 수 있는 다양한 도구를 제공하여 관리 작업을 _사용자에게 적합한_ 프로세스에 통합할 수 있습니다. 다른 Azure 서비스 중 일부에서 인프라 리소스가 원활하게 실행되고 있는지 살펴보겠습니다.
