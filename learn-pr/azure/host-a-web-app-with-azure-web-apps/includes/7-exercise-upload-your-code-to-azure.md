이 단원에서는 Azure 웹앱에 ASP.NET Core 응용 프로그램을 업로드합니다.
...
1. 이전에 만든 웹앱의 콘텐츠 루트 폴더로 이동합니다. 다음을 입력할 수 있습니다.
...
1. 위에서 생성된 스테이징 슬롯을 클릭합니다. 배포 슬롯은 웹앱으로 간주되므로 **모든 리소스** 아래에 웹앱 리소스로 표시됩니다.
