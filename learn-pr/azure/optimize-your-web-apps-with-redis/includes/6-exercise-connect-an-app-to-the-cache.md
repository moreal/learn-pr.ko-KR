...
> [!NOTE]
> 통합 Cloud Shell은 오른쪽에서 사용할 수 있습니다. 여기서 우리가 작성하려는 예제 코드를 만들고 실행하는 명령 프롬프트를 사용하거나, 개발 환경을 설정한 경우 로컬로 다음 단계를 수행합니다. Cloud Shell을 사용하기로 결정한 경우 셸을 선택하라는 메시지가 나타나면 Bash 셸을 선택하세요.
...
1. 온라인 편집기에서 파일을 저장합니다. 오른쪽 상단 모서리를 보면 일반 파일 작업과 관련된 메뉴가 있습니다.
