...
1. [Azure Portal](https://portal.azure.com/triplecrownlabs.onmicrosoft.com?azure-portal=true)의 왼쪽 모서리 세로 막대에서 **리소스 만들기** 단추를 클릭하여 새 리소스 만들기를 시작합니다.
...
1. 적절한 **구독**을 선택하고 기존 **리소스 그룹**, "<rgn>[샌드박스 리소스 그룹 이름]</rgn>"을 사용합니다.
