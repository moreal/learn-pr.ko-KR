...
응용 프로그램 수요가 일정한 경우에는 필요한 리소스 수준을 쉽게 예측할 수 있습니다. 실제 세계에서는 응용 프로그램 수요가 시간에 따라 변하므로 예측하는 데 더 높은 수준이 필요할 수 있습니다. 운이 좋아서 이러한 변화가 예측 가능하거나 계절별 특성일 수 있지만 모든 응용 프로그램에서 일반적인 것은 아닙니다. 되도록 수요를 맞출 수 있는 적절한 양의 리소스를 프로비전하고, 수요의 변경에 따라 조정할 수 있습니다.
