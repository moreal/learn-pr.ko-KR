### <a name="exercise-4-debug-the-bot-locally"></a><span data-ttu-id="8146f-101">연습 4: 로컬로 bot 디버그</span><span class="sxs-lookup"><span data-stu-id="8146f-101">Exercise 4: Debug the bot locally</span></span>
