<span data-ttu-id="ff6fb-101">이 단원에서는 로컬 머신에 **PowerShell**을 설치합니다.</span><span class="sxs-lookup"><span data-stu-id="ff6fb-101">In this unit, you will install **PowerShell** on your local machine.</span></span>
