보안은 아키텍처에서 가장 중요한 요소입니다. 비즈니스 데이터 및 고객 데이터를 안전하게 보호하는 것이 매우 중요합니다. 공개 데이터 침해 사고는 회사의 평판을 떨어트릴 뿐 아니라 막대한 개인적, 재무적 손실을 일으킬 수 있습니다. 이 모듈에서는 클라우드 환경을 디자인할 때 고려해야 할 주요 아키텍처 보안 사항을 알아보겠습니다.
