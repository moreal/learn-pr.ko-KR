...
풀에 더 많은 데이터베이스를 추가할수록 비용이 절감됩니다. 다음 일러스트레이션에서는 기본, 표준, 프리미엄이라는 세 가지 형식의 Elastic Database 풀 기능을 보여줍니다.  기본은 DB당 최대 5eDTU까지, 표준은 DB당 1000eDTU까지, 프리미엄은 DB당 최대 100eDTU까지 자동으로 조정합니다.
