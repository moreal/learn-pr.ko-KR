조명을 켤 때 유일한 문제는 조명이 켜지는지 여부입니다. 전기가 필요하다는 것을 알지만 전기가 제공되는 자세한 방법은 중요하지 않습니다. 어떻게 전기가 발전소에서 생산되고 대규모 고압 송전선 네트워크를 통해 사용자의 도시까지 이동하고 변전소를 지나 최종적으로 사용자의 집에 도달하는지 고려하지 않습니다.
