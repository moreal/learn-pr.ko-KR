이 모듈에서는 Azure Storage 계정이 앱에 적절한지 평가할 때 필요한 디자인 고려 사항을 살펴보았습니다. 네트워킹 연결 디자인 제약 조건으로 인해 앱이 더욱 복잡해질 수 있습니다. 또한 생산성을 크게 향상할 수 있는 사용하는 언어 또는 플랫폼용 클라이언트 라이브러리의 가용성을 고려했습니다.
