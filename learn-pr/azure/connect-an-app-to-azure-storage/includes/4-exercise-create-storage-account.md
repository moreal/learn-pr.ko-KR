<span data-ttu-id="f00d7-101">이제 앱이 있으므로 작업할 Azure 저장소 계정이 필요합니다.</span><span class="sxs-lookup"><span data-stu-id="f00d7-101">Now that we have an app, we need an Azure storage account to work with.</span></span>
